...
void Device::Update()
{
    ...
    Display::SetMeasure(TypeMeasure::MagneticX, GY511::GetMagneticX().ToMagneticXY());
    Display::SetMeasure(TypeMeasure::MagneticY, GY511::GetMagneticY().ToMagneticXY());
    Display::SetMeasure(TypeMeasure::MagneticZ, GY511::GetMagneticZ().ToMagneticZ());
